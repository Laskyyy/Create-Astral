onEvent('recipes', event => {
    event.recipes.custommachinery.custom_machine("createastral:slime_furnace", 600)
        .produceSU(2, 2048)
        .requireItemTag("#c:slimeballs", 1);

    event.recipes.custommachinery.custom_machine("createastral:slime_furnace", 5400)
        .produceSU(2, 2048)
