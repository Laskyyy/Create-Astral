...
onEvent("morejs.villager.trades", (event) => {
    ...
    const customTradesToAdd = [
        ...
        ["minecraft:armorer", 4, ["20x minecraft:emerald"], "minecraft:sturdy_leggings"],
        ["minecraft:armorer", 5, ["20x minecraft:emerald"], "minecraft:sturdy_helmet"],
        ...
        ["minecraft:toolsmish", 2, ["18x minecraft:flint"], "createastral:andesite_compound"]
        ["minecraft:toolsmith", 5, ["6x minecraft:emerald"], "createastral:bronze_sheet"],
        ["minecraft:toolsmith", 5, ["12x minecraft:emerald"], "createastral:sturdy_sheet"],
        ...
        ["techreborn:metallurgist", 3, ["7x minecraft:emerald"], "2x create:iron_sheet"],
        ["techreborn:metallurgist", 3, ["6x minecraft:emerald"], "3x create:copper_sheet"],
        ...
        ["techreborn:metallurgist", 4, ["9x minecraft:emerald"], "2x create:sturdy_sheet"],
        ["techreborn:metallurgist", 5, ["12x minecraft:emerald"], "3x create:propeller"],
        ["techreborn:metallurgist", 5, ["14x minecraft:emerald"], "2x create:brass_hand"],
