...
onEvent("recipes", (event) => {
    ...
    event.recipes
        .createCompacting("createastral:star_shard", [{ fluid: "kubejs:molten_radiance", amount: 8100 }])
        .heated()
        .processingTime(500);
    ...
    event.recipes.createMechanicalCrafting("ad_astra:ostrum_engine", [" F ", "FEF", "FDF", "ABA"], {
    ...
    event.recipes
        .createMixing("doodads:asphalt", [{ fluid: "kubejs:andesite_compound", amount: 3000 }, "#c:concrete_powder"])
        .processingTime(1000);
