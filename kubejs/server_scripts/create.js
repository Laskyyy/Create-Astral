...
function crushingRecipes(event) {
    ...
    [
        ...
        mod.ores.forEach((ore) => {
            ...
            let crushed_ore = "create" + (mod.mod == "ad_astra" ? "astral" : "") + ":crushed_" + ore.name + "_ore";
            let outputs = [
                crushed_ore,
...
function mixingRecipes(event) {
    ...
    [
        ...
        {
            output: Fluid.of("kubejs:blast-resistant_cement", FULL_BUCKET_AMMOUNT),
            input: [
                "#c:concrete_powder",
...
function compactingRecipes(event) {
    ...
    [
        ...
        },
        {
            ...
            inputs: ["ae2:logic_processor_press", { fluid: "tconstruct:molten_gold", amount: FULL_BUCKET_AMMOUNT / 3 }]
        },
        {
