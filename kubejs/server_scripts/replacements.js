onEvent("recipes", (event) => {
    ...
    [
        ...
        [{ type: "minecraft:crafting_shaped" }, "farmersdelight:rope", "campanion:rope"],
        // ['tconstruct:scorched_brick', 'tconstruct:scorched_bricks') // ???
        [{ mod: "tconstruct" }, "minecraft:quartz", "ae2:charged_certus_quartz"],
        ...
        [{ output: "minecraft:shulker_box" }, "minecraft:chest", "minecraft:ender_eye"],
        [{ mod: "createaddition" }, "minecraft:redstone_torch", "create:electron_tube"],
        [{ output: "ad_astra:engine_fan" }, "ad_astra:steel_plate", "ad_astra:iron_plate"],
        [{ output: "ad_astra:engine_frame" }, "ad_astra:steel_plate", "ad_astra:iron_plate"],
        ...
        [{ output: "ad_astra:space_helmet" }, "minecraft:orange_stained_glass_pane", "create:diving_helmet"],
        ...
        [{ output: "ad_astra:netherite_space_helmet" }, "ad_astra:compressed_steel", "ad_astra:ostrum_block"],

        [{ output: "ad_astra:netherite_space_suit" }, "ad_astra:compressed_steel", "ad_astra:ostrum_block"],

        [{ output: "ad_astra:netherite_space_pants" }, "ad_astra:compressed_steel", "techreborn:lead_plate"],

        [{ output: "ad_astra:netherite_space_boots" }, "ad_astra:compressed_steel", "techreborn:lead_plate"],
        ...
        [{ mod: "techreborn" }, "techreborn:copper_plate", "create:copper_sheet"],
        ...
        [{ mod: "techreborn" }, "techreborn:chrome_plate", "ad_astra:compressed_ostrum"],
        [{ mod: "techreborn" }, "techreborn:chrome_ingot", "ad_astra:compressed_ostrum"],
        ...
        [{ output: "techreborn:industrial_grinder" }, "techreborn:electronic_circuit", "ad_astra:compressed_calorite"],
