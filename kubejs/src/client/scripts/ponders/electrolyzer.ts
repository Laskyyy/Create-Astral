...
export function electrolyzerPonder() {
  onEvent("ponder.registry", (event) => {
    event
      .create("createastral:electrolyser_dummy")
      .scene("electrolyzer", "How to create the electrolyzer multiblock", "kubejs:electrolyser", (scene, util) => {
        const electrolyzerPos: Vec3 = [2, 2, 1];
        const electrolyzerPos2: Vec3 = [2, 3, 1];
        const multiblockRange: [Vec3, Vec3] = [
          [1, 2, 1],
          [3, 4, 3],
        ];
