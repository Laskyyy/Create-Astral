...
export const BUCKET = 81000;
export const GEM_BLOCK = 72900;
export const SLIMEBALL = 20250;
export const INGOT = 9000;
export const GEM = 8100;
export const NUGGET = 1000;

export const mB = 81;

export const oxidisationTypes = ["exposed", "weathered", "oxidized"] as const;
export const oxidizationTypes = oxidisationTypes
export const vanillaCopperBlocks = ["cut_copper", "cut_copper_stairs", "cut_copper_slab"] as const;
export const createCopperBlocks = [
  "copper_shingles",
  "copper_shingle_slab",
