export function dragon() {
  function bossSpawner(event: Internal.BlockRightClickEventJS) {
  ...
  function takeItem(event: Internal.BlockRightClickEventJS) {
  ...
  function damageTool(event: Internal.BlockRightClickEventJS) {
