export function astralSignalsPPDecryptorRecipes() {
  onEvent("recipes", (event) => {
    // Can only be one input and output
    // Requires continuous power to operate
    // Time is measured in ticks (20 ticks = 1 second)

    // The block will only accept dormant tier 1 drives as inputs, change the machine registry in kubejs/data/astralsignals/machines/pp_decryptor.json if you wish to modify this
