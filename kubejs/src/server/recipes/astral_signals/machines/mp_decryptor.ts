export function astralSignalsMPDecryptorRecipes() {
  onEvent("recipes", (event) => {
    ...
    // The block will only accept dormant tier 2 drives and subatomic ingots as inputs, change the machine registry in kubejs/data/astralsignals/machines/mp_decryptor.json if you wish to modify this
