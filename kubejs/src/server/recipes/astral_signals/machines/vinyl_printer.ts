export function astralSignalsVinylPrinterRecipes() {
  onEvent("recipes", (event) => {
    ...
    // The block will only accept decrypted drives and polyvinyl discs as inputs, change the machine registry in kubejs/data/astralsignals/machines/vinyl_printer.json if you wish to modify this

    interface PrinterRecipe {
      drive: Special.Item,
      disc: Special.Item,
      output: Special.Item,
    }

    const printerRecipes: PrinterRecipe[] = [
      {
