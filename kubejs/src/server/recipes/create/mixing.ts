import { BUCKET, GEM, INGOT, mB, NUGGET, SLIMEBALL } from "fluid-constants";

export function createMixingRecipes() {
  onEvent("recipes", (event) => {
     ...
     * @author Max Norfolk
     */
    const deadBushFlowerRevivingRecipes: FlowerMixingRecipe[] = [
      {
    ...
    interface SmallToTallFlowerMixingRecipe {
      tallFlower: Special.Item;
      flower: Special.Item;
    }

    /// Array format: [2 tall flower, 1 tall flower]
    const smallToTallFlowerMixingRecipes: SmallToTallFlowerMixingRecipe[] = [
      {
   ...
   */
  function farmersCompatMixing(event: Internal.RecipeEventJS) {
