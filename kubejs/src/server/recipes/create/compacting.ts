import { BUCKET, GEM, INGOT, mB, NUGGET } from "fluid-constants";
...
export function createCompactingRecipes() {
  ...
  function lakyCompactingRecipes(event: Internal.RecipeEventJS) {
    const recipeList: CompactingRecipe[] = [
      {
