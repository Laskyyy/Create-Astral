export function recipeReplacements() {
  onEvent("recipes", (event) => {
    ...
    [
      ...
      [{ output: "ad_astra:netherite_space_suit" }, "minecraft:netherite_chestplate", "createastral:sturdy_chestplate"],
      ...
      [{ mod: "techreborn", output: "techreborn:advanced_drill" }, "ad_astra:calorite_plate", "techreborn:lead_plate"],
      [
