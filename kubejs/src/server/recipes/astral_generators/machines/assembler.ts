export function astralGeneratorsAssemblerRecipes() {
  ...
  function assemblerConvergenceCore(event: Internal.RecipeEventJS) {
    event.custom({
  ...
  function assemblerFluidBoiler(event: Internal.RecipeEventJS) {
    event.custom({
      type: "custommachinery:custom_machine",
      machine: "astralgenerators:assembler",
      time: 100,
  ...
  function assemblerFusionReactor(event: Internal.RecipeEventJS) {
    event.custom({
      type: "custommachinery:custom_machine",
      machine: "astralgenerators:assembler",
      time: 100,
  ...
  function assemblerParticleAccelerator(event: Internal.RecipeEventJS) {
    event.custom({
      type: "custommachinery:custom_machine",
      machine: "astralgenerators:assembler",
      time: 100,
  ...
  function assemblerSolidBoiler(event: Internal.RecipeEventJS) {
    event.custom({
      type: "custommachinery:custom_machine",
      machine: "astralgenerators:assembler",
      time: 100,
  ...
  function assemblerSteamTurbine(event: Internal.RecipeEventJS) {
    event.custom({
      type: "custommachinery:custom_machine",
      machine: "astralgenerators:assembler",
      time: 100,
