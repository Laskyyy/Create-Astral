import { CREATE_COPPER_BLOCKS, OXIDIZATION_TYPES, VANILLA_COPPER_BLOCKS } from "constants";
...
export function minecraftStonecuttingRecipes() {
  onEvent("recipes", (event) => {
    copperOxidising(event);

    const stonecuttingRecipes: StonecuttingRecipe[] = [
      {
  ...
  function copperOxidising(event: Internal.RecipeEventJS) {
