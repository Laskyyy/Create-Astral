 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "fabric.event.register", handler: (event: Internal.FabricEventRegisterEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ServerLifecycleEvents.ServerStarted", handler: (event: Internal.ProxyEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **client**.
 * 
