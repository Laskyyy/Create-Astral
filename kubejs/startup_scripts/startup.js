...
onEvent("item.registry", (event) => {
    ...
    event
        ...
        .food((food) => {
            food.hunger(0).saturation(00).effect("drinkbeer:drunk", 3000, 0, 1).alwaysEdible();
        });
...
onEvent("item.tooltip", (e) => {
    const tooltips = [
...

        {
            ...
            tooltip: "No longer superheats! Use processes in Chapter 4 to superheat blaze burners.",
        },
        ...
        { item: "ae2:certus_quartz_dust", tooltip: "Gated by reaching the Moon!" },
        {
            ...
            tooltip: "Blazes can be found in a certain structure on the Moon...",
        },
        {
            item: "minecraft:rotten_flesh",
            tooltip: "Chewy... might make a good source of leather?",
        },
        {
            item: "computercraft:disk",
            tooltip: "This recipe is wierd it actually uses redstone, not rose quartz.",
        },
        ...
        {
            item: "computercraft:disk",
            tooltip: "This recipe is weird it actually uses redstone, not rose quartz.",
        },
        ...
        },
        {
            ...
            tooltip:
                "Nether is Disabled. Nether content is distributed across planets. Follow the questbook for more info.",
        },
        ...
        { item: "techreborn:silver_ore", tooltip: "This metal is found on the moon. Y=65" },
        {
            ...
            tooltip: "This metal is found on the moon. Y=65",
        },
...
onEvent("worldgen.add", (event) => {
    ...
    event.addOre((ore) => {
        ...
        ore.count([3, 5]).squared().triangleHeight(-64, 64);
        ore.size = 15;
    });
