onEvent("ponder.registry", event => {
    event.create("createastral:stone_growth_chamber_dummy").scene("set_replace_modify_tutorial", "Stone Growth Chamber", (scene, util) => {
        ...
        scene.text(30, "Polished Andesite", [3, 1, 3])
        ...
        scene.text(30, "Lava in the middle", [3, 1, 3])
        ...
        scene.idle(70);
        scene.text(80, "Use an Andesite Funnel on the front or a Hopper on the bottom to output Andesite", [2, 2.5, 1])
        scene.idle(90);
