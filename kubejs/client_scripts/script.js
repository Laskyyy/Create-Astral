...
onEvent("jei.hide.items", (event) => {
    ...
    event.groupItems("kubejs:rei_groups/chipped", "chipped", [Ingredient.of("@chipped").getItemIds()]);
});

onEvent("rei.group", (event) => {
    event.groupItems("kubejs:rei_groups/chipped", "Chipped Blocks", [Ingredient.of("@chipped").getItemIds()]);
